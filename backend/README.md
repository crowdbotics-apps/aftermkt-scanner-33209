...
## Project Structure
    ...
    ├── aftermkt_scanner_33209  # Django project configurations
...
1. Clone this repo and `cd aftermkt_scanner_33209`
...
2. Clone this repo and `cd aftermkt_scanner_33209`
